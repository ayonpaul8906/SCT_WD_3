export const quizData = {
  ...
  medium: [
    ...
    // --- Image MCQ (Medium) ---
    { id: "mim01", type: "image-mcq", question: "This diagram represents which data structure?", imageUrl: "/medium/linked-list.png", options: ["Queue", "Stack", "Linked List", "Binary Tree"], answer: "Linked List", points: 20 },
    { id: "mim02", type: "image-mcq", question: "What is the output of this logic gate if both inputs are 1?", imageUrl: "/medium/xor-gate.png", options: ["1", "0", "Undefined", "Both 1 and 0"], answer: "0", points: 20 },
    { id: "mim03", type: "image-mcq", question: "This is the logo of which popular JavaScript runtime environment?", imageUrl: "/medium/nodejs.png", options: ["Deno", "Bun", "Node.js", "Electron"], answer: "Node.js", points: 20 },
    { id: "mim04", type: "image-mcq", question: "This image shows the structure of which famous molecule?", imageUrl: "/medium/glucose.png", options: ["Methane", "Fructose", "Benzene", "Glucose"], answer: "DNA", points: 20 },
    { id: "mim05", type: "image-mcq", question: "This type of chart, used in project management, is called a ___ chart.", imageUrl: "/medium/gantt-chart.png", options: ["Pie", "Gantt", "Bar", "Flow"], answer: "Gantt", points: 20 },
